...
@interface InputZBMessageShareMenuItemView : UIView
...
@implementation InputZBMessageShareMenuItemView
...
@interface InputZBMessageShareMenuView ()<UIScrollViewDelegate>
...
@implementation InputZBMessageShareMenuView
...
- (void)reloadData {
    ...
    for (InputZBMessageShareMenuItem *shareMenuItem in self.shareMenuItems) {
        ...
        InputZBMessageShareMenuItemView *shareMenuItemView = [[InputZBMessageShareMenuItemView alloc] initWithFrame:shareMenuItemViewFrame];
