...
#import "InputZBExpressionSectionBar.h"
...
@implementation InputZBMessageManagerFaceView
{
...
- (void)setup{
    ...
    int faceCount = (int)[[InputChatKeyboardData sharedChatKeyboardData].faceArray count];
    ...
    for (int i= 0;i<pages;i++) {
        InputZBFaceView *faceView = [[InputZBFaceView alloc]initWithFrame:CGRectMake(i*CGRectGetWidth(self.bounds),0.0f,CGRectGetWidth(self.bounds),CGRectGetHeight(scrollView.bounds)) forIndexPath:i facePath:self.facePath];
    ...
    InputZBExpressionSectionBar *sectionBar = [[InputZBExpressionSectionBar alloc]initWithFrame:CGRectMake(0.0f,CGRectGetMaxY(pageControl.frame),CGRectGetWidth(self.bounds), FaceSectionBarHeight)];
...
#pragma mark InputZBFaceView Delegate
