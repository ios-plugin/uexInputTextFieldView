...
@implementation InputZBMessageTextView
...
-(void)setPlaceHolder:(NSString *)placeHolder{
    ...
    NSUInteger maxChars = [InputZBMessageTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText{
    NSUInteger lines = [InputZBMessageTextView numberOfLinesForMessage:self.text];
    return lines;
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text{
    ...
    NSUInteger maxLine = [InputZBMessageTextView maxCharactersPerLine];
